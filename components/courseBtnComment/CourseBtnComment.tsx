...
const CourseBtnComment = ({courseDetails} : any) => {
    const [isModalOpen, setIsModalOpen] = useState(false);
    const [stars, setStars] = useState(0);
    const [name, setName] = useState('');
    const [comment, setComment] = useState('');

    const course_id = courseDetails.id; // Assuming 'id' is the unique identifier for each course in the courseDetails object
