...
const FatwaForm = () => {
  ...
  return (
    ...
    >
      ...
      <div className='relative h-full bkColor rounded-tl-none rounded-br-[220px] rounded-tr-none md:rounded-tr-[235px] rounded-bl-[200px] md:rounded-bl-none w-full mr-auto'>
